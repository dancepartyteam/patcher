...
class Games {
    /**
     * 
     * @param {*} platform Must be "WII" or "PS3"
     */
    constructor(platform = "WII") {
    ...
    // Get game by its ID
    getGameById(gameId) {
        return this.games.find(g => g[this.platform].ids[gameId]);
    };

    // Get game by its version
    getGameByVersion(version) {
        return this.games.find(g => g[this.platform].version == version);
    };
